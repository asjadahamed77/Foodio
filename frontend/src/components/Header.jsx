...
const Header = () => {
  ...
  const toggleMobileProfile = () => setMobileProfileClicked(!mobileProfileClicked);
  ...
  return (
    <div className="py-4 px-6 flex flex-col relative z-50">
      ...
      <div className="flex justify-between items-center box-border">
        ...
        <div className="group relative">
          <div
            ...
            className="backdrop-blur-md rounded-4xl p-4 bg-white/5 cursor-pointer border border-white/10 shadow-sm transition-all duration-200 hover:bg-white/10"
          >
            <FaCircleUser className="text-2xl" />
          </div>
          <div
            className={`absolute right-0 p-4 ${
              mobileProfileClicked ? "opacity-100" : ""
      ...
      <ul
        className={`fixed left-0 right-0 bottom-0 z-40 bg-white/5 backdrop-blur-md border border-white/10 shadow-md rounded-3xl p-6 text-center transition-transform duration-300 ease-linear ${
